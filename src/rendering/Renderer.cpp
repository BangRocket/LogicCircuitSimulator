...
void Renderer::Render(ProgramState currentState, Component* wireStartComponent, int wireStartPin, Vector2 wireEndPos, bool showDebugInfo, Component* selectedComponent, ComponentType currentComponentType, float placementRotation) {
    BeginDrawing();
    ...
    if (showDebugInfo) {
        DrawDebugInfo(currentState, currentComponentType, placementRotation);
    }
...
void Renderer::DrawDebugInfo(ProgramState currentState, ComponentType currentComponentType, float placementRotation) {
